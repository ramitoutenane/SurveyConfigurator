...
namespace SurveyConfiguratorApp
{
    ...
    /// </summary>
    class SmileyQuestionDatabaseOperations : ICRUDable<SmileyQuestion>
    {
        ...
        public int Create(SmileyQuestion data)
        {
            int tQuestionId = -1;
            try
            {
                ...
                if (tQuestionId < 1)
                    return tQuestionId;
                string tCommandString = $"INSERT INTO {DatabaseStringValues.cTABLE_SMILEY_QUESTION} ({DatabaseStringValues.cCOLUMN_QUESTION_ID}, {DatabaseStringValues.cCOLUMN_FACES_NUMBER}) OUTPUT INSERTED.{DatabaseStringValues.cCOLUMN_QUESTION_ID} " +
                    $"VALUES ({DatabaseStringValues.cPARAMETER_QUESTION_ID}, {DatabaseStringValues.cPARAMETER_QUESTION_FACES_NUMBER})";
                ...
                using (SqlConnection tConnection = new SqlConnection(mConnectionString))
                {
                    using (SqlCommand tCommand = new SqlCommand(tCommandString, tConnection))
                    {
                        ...
                        tCommand.Parameters.AddWithValue($"{DatabaseStringValues.cPARAMETER_QUESTION_FACES_NUMBER}", data.NumberOfFaces);
                        tConnection.Open();
        ...
        public bool Update(SmileyQuestion data)
        {
            try
            {
                ...
                string tCommandString = $"UPDATE {DatabaseStringValues.cTABLE_SMILEY_QUESTION} SET {DatabaseStringValues.cCOLUMN_FACES_NUMBER} = {DatabaseStringValues.cPARAMETER_QUESTION_FACES_NUMBER} WHERE {DatabaseStringValues.cCOLUMN_QUESTION_ID} = {DatabaseStringValues.cPARAMETER_QUESTION_ID} ";
        ...
        public SmileyQuestion Read(int id)
        {
            try
            {
                string tQueryString = $"SELECT {DatabaseStringValues.cCOLUMN_QUESTION_TEXT}, {DatabaseStringValues.cCOLUMN_QUESTION_ORDER}, {DatabaseStringValues.cCOLUMN_FACES_NUMBER}, {DatabaseStringValues.cTABLE_QUESTION}.{DatabaseStringValues.cCOLUMN_QUESTION_ID}, {DatabaseStringValues.cCOLUMN_TYPE_ID} " +
                    $"FROM {DatabaseStringValues.cTABLE_QUESTION}, {DatabaseStringValues.cTABLE_SMILEY_QUESTION} WHERE {DatabaseStringValues.cTABLE_QUESTION}.{DatabaseStringValues.cCOLUMN_QUESTION_ID} = {DatabaseStringValues.cPARAMETER_QUESTION_ID} AND {DatabaseStringValues.cTABLE_QUESTION}.{DatabaseStringValues.cCOLUMN_QUESTION_ID} = {DatabaseStringValues.cTABLE_SMILEY_QUESTION}.{DatabaseStringValues.cCOLUMN_QUESTION_ID}";
        ...
        public List<SmileyQuestion> ReadAll(int offset = 0, int limit = 0)
        {
            try
            {
                string tQueryString = $"SELECT {DatabaseStringValues.cCOLUMN_QUESTION_TEXT}, {DatabaseStringValues.cCOLUMN_QUESTION_ORDER}, {DatabaseStringValues.cCOLUMN_FACES_NUMBER}, {DatabaseStringValues.cTABLE_QUESTION}.{DatabaseStringValues.cCOLUMN_QUESTION_ID}, {DatabaseStringValues.cCOLUMN_TYPE_ID} " +
                    $"FROM {DatabaseStringValues.cTABLE_QUESTION}, {DatabaseStringValues.cTABLE_SMILEY_QUESTION} WHERE {DatabaseStringValues.cTABLE_QUESTION}.{DatabaseStringValues.cCOLUMN_QUESTION_ID} = {DatabaseStringValues.cTABLE_SMILEY_QUESTION}.{DatabaseStringValues.cCOLUMN_QUESTION_ID} " +
